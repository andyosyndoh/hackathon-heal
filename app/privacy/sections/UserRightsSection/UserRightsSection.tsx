...
export const UserRightsSection = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col items-center gap-3 py-9">
      ...
      <p className="[font-family:'Inter',Helvetica] font-light text-[#403f3e] text-sm text-center tracking-[0] leading-6">
        Protecting Your Data: Safeguarding Your Privacy in an Online World
      </p>
    </section>
  );
};
